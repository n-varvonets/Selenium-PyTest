import os
element = 'найденный елеент в'

current_dir = os.path.abspath(os.path.dirname(__file__))    # получаем путь к директории текущего исполняемого файла
"""В эту же папку кладем файл, который хотим прикрепить, то есть file.txt."""
file_path = os.path.join(current_dir, 'file.txt')           # добавляем к этому пути имя файла
# print(os.path.abspath(__file__))
# >>> C:\Users\NIk\PycharmProjects\Selenium_tests_cases\Stepic\module2_less2_step7,8(Tasks for upload files).py
# print(os.path.abspath(os.path.dirname(__file__)))
# >>> C:\Users\NIk\PycharmProjects\Selenium_tests_cases\Stepic
